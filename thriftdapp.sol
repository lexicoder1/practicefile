...
contract mappingS{
    ...
    function giveMyMoney(address collector,uint howMuch,uint ajoID) public {
        ...
        Ajo storage f=Ajos[ajoID];
        require(f.aMember[msg.sender]==true && f.aMember[collector]==true,"the guy no dey here");
        require(f.amountDepo[msg.sender]>=howMuch,"OLE");
        f.amountDepo[msg.sender]-=howMuch;
        f.amountDepo[collector]+=howMuch;
    }
